...
mkdir -p /work/$USER/reproducible_demo/project_repo /work/$USER/reproducible_demo/workspace
...
bash reproducibility_demo_slurm.sh /work/$USER/reproducible_demo/workspace '-A chsi -p chsi'
```
> If you don't have access to the CHSI partition, leave off '-A chsi -p chsi'
...
## What is Reproducible Analysis? {.build}
  "Reproducible Analysis is an important ***part*** of reproducible research.  Reproducible analysis requires that all components of the analysis be archived so that ***anyone*** can independently repeat the analysis and arrive at exactly the same results" 
  - Josh Granek
...
### Containerization for Reproducible Research
  ...
  - Sharebility: [Docker Hub](https://hub.docker.com), [Singularity Container Services](https://cloud.sylabs.io)
...
## Git-repository Hosts
  - [Github](https://github.com/)
    - [Github Education Discounts](https://docs.github.com/en/education/explore-the-benefits-of-teaching-and-learning-with-github-education/github-global-campus-for-students/apply-to-github-global-campus-as-a-student)
  - [Bitbucket](https://bitbucket.org)
  - [Gitlab](https://about.gitlab.com)
    - [Duke Gitlab Instance](https://gitlab.oit.duke.edu)
...
### Git for Version Control
  ...
  - Installing Git: https://swcarpentry.github.io/workshop-template/#git (this URL is finicky as a link)
  - [Sourcetree: a free GUI for git](https://www.sourcetreeapp.com)
  - [Git in RStudio](git_overview.md)
